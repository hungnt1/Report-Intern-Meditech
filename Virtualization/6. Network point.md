...
- Trong mode này , bridge sẽ không được gắn vào một host interface nào, và thay vào đó sử NAT + Forwarding để chuyển tiếp các gọi tin của VM ra các cổng của host để thực hiện kết nối ra mạng ngoài
