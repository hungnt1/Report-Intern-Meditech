...
- Trong mode này , bridge sẽ không được gắn vào một host interface nào, và thay vào đó sử dụng IPtable Forwarding để chuyển tiếp các gọi tin của VM ra các cổng mạng của host để thực hiện kết nối ra mạng ngoài
