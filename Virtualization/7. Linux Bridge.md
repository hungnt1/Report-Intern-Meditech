...
`brctl addif br10 ens33`
`brctl stp br10 on`  ( nếu cần dùng STP )
![](https://imgur.com/6KQaSdx.png)

** Bước 3 : Sau khi tạo một bridge mới tên **br10** sẽ xuất hiện thêm 1 NIC trùng tên với bridge
Ta có thể cấu hình xin cấp phát IP cho NIC này sử dụng command
...
![](https://imgur.com/bW1rlih.png)

**Bước 5:** Để kiểm tra, ta có tạo 1 máy ảo và gắn vào **br10**

- Cấu hình card mạng cho máy ảo

![](https://i.imgur.com/aVAk4m5.png)


- Kiểm tra trên máy ảo Centos 
![](https://imgur.com/Lt7wtJR.png)
