...
- Nova-compute chạy trên cách compute node 2. Compute service tương tác tới các Hypervisor để quản lý vòng đời các instance và đảm bảo state instance được lưu trong Compute Database 
