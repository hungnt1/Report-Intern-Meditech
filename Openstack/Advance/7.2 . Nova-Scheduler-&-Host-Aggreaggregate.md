...
## 2. Tìm hiểu khái niệm _Host aggregate_ và 
...
- Các metadata trong các  host aggregate  thường được dùng để cung cấp thông tin cho quá trình nova-scheduler  để xác định được được host đặt các mảy ảo . Metadata được chỉ định vào một host aggregate sẽ không được dùng  để khởi tạo một instance có flavor có cùng metata
