...
## Overview Storage
Trong Ovirt gồm có 3 kiểu storage domain 
- **Data Domain** : dùng để chứa các ổ đĩa của máy ảo, chưa các snapshot và OVF và template  của Data Center
- **ISO Domain **: để lưu trữ các file ISO cho quá trình cài đặt và boot OS  
- **Export Domain** : dùng để lưu trữ tạm thời các ổ đĩa ảo, image trong quá trình di dời giữa ác datacenter 

Ỗ đĩa ảo trong Ovirt gồm 2 định dạng : QCOW2 và RAW
